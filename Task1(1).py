...
class todo:
    def __init__(self, root):
        ...
        self.main_text = Listbox(self.root, height=2, bd=5, width=23, font="ariel, 20, italic bold")
        ...
        self.button = Button(self.root, text="Add", font='sarif, 20 bold italic', 
                width=10,bd=5,bg='orange',fg='black',comand=add)
        self.button.place(x=30, y=180)

        self.button2 = Button(self.root, text="Delete", font='sarif, 20 bold italic', 
                width=10,bd=5,bg='orange',fg='black',comand=delete)
